...
const PublicProfilePage = () => {
  ...
  const badgeCatalog = {
    bugHunter: { label: 'BUG Hunter', image: 'https://api.scraphub.org/uploads/badges/bughunter.png', glow: '#e63946' },
    qlf: { label: 'QLF', image: 'https://api.scraphub.org/uploads/badges/qlf.png', glow: '#e63946' },
    eternal: { label: 'Éternel', image: 'https://api.scraphub.org/uploads/badges/eternal.png', glow: '#ffffff' },
    premium: { label: 'Premium', image: 'https://api.scraphub.org/uploads/badges/prenium.png', glow: '#f50aed' },
    verified: { label: 'Verified', image: 'https://api.scraphub.org/uploads/badges/verified.png', glow: '#10b981' },
    leet: { label: '1337', image: 'https://api.scraphub.org/uploads/badges/1337.png', glow: '#e63946' }
  };
